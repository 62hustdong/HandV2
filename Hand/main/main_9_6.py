...
class CalibCameraWindow(QMainWindow, Ui_CalibCameraWindow):
    def __init__(self):
        ...
        self.captureWindow.luiBT.clicked.connect(self.captureWindow.luiBT_clicked)
    ...
    def runUpdateCaptureWindow(self):
        ...
        self.captureWindow.SoLB.setText('0')
...
class CaptureWindow(QMainWindow, Ui_CaptureWindow):
    def __init__(self):
        ...
        self.luiBT.clicked.connect(self.luiBT_clicked)
        ################### 2.13 end chup button ######################
        ...
        if self.frame is not None:
            ...
            if self.index <= 14:
                ...
                if status == False:
                    ...
                    self.len_mang_diem = len(mang_diem)
                    self.mang_kq = self.mang_kq + mang_diem
                    # print("{}: {}".format(len(self.mang_kq), self.mang_kq))
    ...
    def luiBT_clicked(self):
        if self.index != 1:
            # xoá mang ket qua cu
            del self.mang_kq[-self.len_mang_diem:]
            # print('sau: {}'.format(self.index))
            self.SoLB.setText(str(self.index - 2))
            file_path = r"{}/{}.png".format(self.mydir, self.index - 1)
            os.remove(file_path)
            self.index = self.index - 1
