...
from App.function.TongHop import *
from App.gui.IntroductionUI import Ui_IntroductionWindow
from App.gui.CaptureUI import Ui_CaptureWindow
from App.gui.CalibCameraUI import Ui_CalibCameraWindow
from App.function.Calib import *
...
class CalibCameraWindow(QMainWindow, Ui_CalibCameraWindow):
    ...
    def runUpdateCaptureWindow(self):
        ...
        self.captureWindow.path_data = self.pickle_path
    ...
    def calibBT_clicked(self):
        ...
        if self.ngang == 0 or self.doc == 0 or self.kichThuoc == 0:
            ...
            reply = QMessageBox.question(self.centralwidget, 'Question',
                                         ...
                                         QMessageBox.No)
            if reply == QMessageBox.Yes:
                file_path, _ = QFileDialog.getSaveFileName(self, "Save Camera Matrix", "",
                                                           "P File(*.p);;All Files(*.*) ")
                if file_path == "":
                    return
                print(file_path)
...
class CaptureWindow(QMainWindow, Ui_CaptureWindow):
    def __init__(self, screen_show, man_hinh_number,
                 huong_number, chanel, contrast_adjuster, brightness_adjuster, camera_matrix, dist, mm_tren_pixel):
        super(CaptureWindow, self).__init__()
        self.mang_ket_qua_hien_thoi = []
        self.mang_kich_thuoc = []
        self.camera_matrix = camera_matrix
        self.dist = dist
        self.mm_tren_pixel = mm_tren_pixel
        self.mang_kq = []
        self.img_cur = None
        self.data2 = None
        self.data1 = None
        ...
        self.cameraLogic = -1
        self.man_hinh_number = man_hinh_number
        self.huong_number = huong_number
        self.chanel = chanel
        self.path_data = None
        self.setupUi(self)
        ...
        if self.frame is not None:
            ...
            if self.index <= 14:
                ...
                if status == False:
                    ...
                    print(self.mang_ket_qua_hien_thoi)
    ...
    #     #
    #     for i in range(1, 57):
    #         self.mang_kich_thuoc.append(i)
    #     for i in range(1, 107):
    #         self.mang_ket_qua_hien_thoi.append((i, i))
    #
    #     print(self.mang_ket_qua_hien_thoi)
    #     #
    #     # # anh_chup = []
    ...
    def CameraRun(self):
        while self.cameraLogic != -1:
            ...
            while self.cap.isOpened():
                self.anhMauLB.setPixmap(QPixmap(u"../handsample/" + str(self.index) + ".jpg"))
                # Capture the video frame
                # by frame
